...
export default function App() {
  ...
  return (
    <web.main style={{ width:"100%",height:"90%",background: props.open.to([0, 1], ['#f0f0f0', "#D173B6"]) }}>
        <h1  style={{fontFamily:"Baloo 2, sans-serif" , fontSize:60, fontWeight:"bold", opacity: open ? 0 : 1 , textAlign:"center" , paddingTop:10}}>
          clica ↓ aqui
        </h1>
      ...
      <web.div style={{ opacity: open ? 1 : 0 }}>
         <Fabs />
      </web.div>
    </web.main>
  )
